...
cluster_df_ambig_prop %>% 
    ggplot() + geom_point(aes(x = as.numeric(threshold), 
                              y = prop_n_assigned, color = as.factor(n_assigned))) +
    geom_line(aes(x = as.numeric(threshold), y = prop_n_assigned, color = n_assigned)) +
