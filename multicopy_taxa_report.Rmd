...
```{r taxaAmbig, anchor="Figure", fig.align="center",echo=FALSE, message=FALSE, fig.cap="Proportion of cluster with more than one assigned taxa by clustering threshold and taxonomic level.", , fig.height=3.5,fig.width=6}
anno_count_fig_df %>%  
