...
ambig_node_labels <- cluster_97_name_key %>% filter(ambig == "multiple", "single") %>% 
    .$rep_name %>% unique()
...
ggtree(tree3, layout="circular", aes(color=group)) + scale_color_manual(values = cols, breaks=1:2, labels=c("Ambiguous"))+ 
    theme(legend.position="bottom")
```
