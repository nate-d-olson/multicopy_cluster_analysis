...
```{r copyDist, anchor = "Figure", echo=FALSE, message=FALSE, fig.cap="Distribution in the number of gene copies present in a bacterial genome.", fig.height=3,fig.width=3}
...
```{r fullTree, anchor = "Figure", echo=FALSE, message=FALSE, fig.cap="Phylogeny of 16S rRNA gene copy database used in this study.", fig.height=6,fig.width=6}
...
```{r clusterSize, anchor = "figure", echo=FALSE, message=FALSE, fig.cap="Distribution of cluster size, number of sequences assigned to a cluster, by clustering threshold.", fig.height=4,fig.width=5}
...
```{r copyNumVar, anchor="Figure", echo = FALSE, fig.cap = "Variability number of 16S rRNA copies for sequences assigned to a cluster by genome. Top plot is the standard deviation of the copy numbers and bottom plot is the proportion of cluster with multiple copy numbers (Mixed), and single copy number values (Uniform)", fig.height=6,fig.width=6}
p
```
...
```{r ambigAssign, anchor="Figure", echo=FALSE, message=FALSE, fig.cap="Proportion of genomes assigned to multiple clusters by clustering threshold.", fig.height=4,fig.width=6}
...
```{r taxaAmbig, anchor="Figure", echo=FALSE, message=FALSE, fig.cap="Proportion of cluster with more than one assigned taxa by clustering threshold and taxonomic level.", , fig.height=4,fig.width=6}
anno_count_fig_df %>%  
